...
void main() {
  ...
  group('Ethereum transaction tests - ', () {
    ...
    test('BSC native transaction', () {
      ...
      expect(hex.decode(signedBscTx.rawTx as String).length, 106);
    ...
    test('Ethereum native transaction', () {
      ...
      expect(hex.decode(signedEthTx.rawTx as String).length, 113);
    ...
    test('Ethereum Classic native transaction', () {
      ...
      expect(hex.decode(signedEtcTx.rawTx as String).length, 106);
    ...
    test('Polygon native transaction', () {
      ...
      expect(hex.decode(signedEthTx.rawTx as String).length, 115);
      expect(signedEthTx.toJson(), {
        'txid':
